...
from robosuite.environments.manipulation.humanoid_reach import HumanoidReach
from robosuite.environments.manipulation.humanoid_drawer import HumanoidDrawer
