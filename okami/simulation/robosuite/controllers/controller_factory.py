...
def gripper_controller_factory(name, params):
    ...
    if name == "GRIP":
        ...
        return gripper_controllers.GripperJointPositionController(interpolator=interpolator, **params)
            #generic.JointPositionController(interpolator=interpolator, **params)
    raise ValueError("Unknown controller name: {}".format(name))
