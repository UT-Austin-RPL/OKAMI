...
class BowlObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/red_bowl.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class ShortCabinetObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/short_cabinet.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005"), ],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class WhiteStorageBoxObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/white_storage_box.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005"), ],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class WoodenCabinetObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/wooden_cabinet.xml"),
            name=name,
