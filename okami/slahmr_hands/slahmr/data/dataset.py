...
class MultiPeopleDataset(Dataset):
    ...
    def load_data(self, interp_input=True):
        ...
        for i, tid in enumerate(self.track_ids):
            ...
            pose_init, orient_init, trans_init, _, left_hand_pose_init, right_hand_pose_init = load_smpl_preds(
                pred_paths, interp=interp_input
            )
            
            hand_pose_init = np.concatenate([left_hand_pose_init, right_hand_pose_init], axis=1)
            ...
            data_out["init_hand_pose"].append(hand_pose_init)
    ...
    def __getitem__(self, idx):
        ...
        obs_data["init_hand_pose"] = torch.Tensor(self.data_dict["init_hand_pose"][idx])
